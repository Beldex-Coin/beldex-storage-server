...
constexpr auto MNODE_SENDER_HEADER = "X-Beldex-Mnode-PubKey";
constexpr auto MNODE_TARGET_HEADER = "X-Target-Mnode-Key";
constexpr auto MNODE_SIGNATURE_HEADER = "X-Beldex-Mnode-Signature";
