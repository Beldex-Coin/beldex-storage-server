...
public:
        ...
        }
    {
        ...
        if (fk_enabled != 1) {
            BELDEX_LOG(critical, "Failed to enable foreign key constraints; perhaps this sqlite3 is compiled without it?");
    ...
    END;
        ...
        if (db.tableExists("Data")) {
            ...
            while (old_owners.executeStep()) {
                ...
                if (old_owner.size() == 66 && util::starts_with(old_owner, "bd") && oxenc::is_hex(old_owner)) {
                    type = 189;
