...
class HTTPS {
  public:
    ...
    // Adds headers that go onto every request such as X-Beldex-Mnode-Signature and Server
    ...
    mnode::MasterNode& master_node() { return master_node_; }
