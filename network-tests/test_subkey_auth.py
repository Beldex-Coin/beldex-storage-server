...
def test_retrieve_subkey(omq, random_mn, sk, exclude):
...
def test_store_subkey(omq, random_mn, sk, exclude):
...
def test_expire_subkey(omq, random_mn, sk, exclude):
    swarm = ss.get_swarm(omq, random_mn, sk)
...
def test_revoke_subkey(omq, random_mn, sk, exclude):
    swarm = ss.get_swarm(omq, random_mn, sk, 3)
