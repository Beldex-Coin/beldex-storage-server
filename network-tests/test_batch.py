...
def test_batch_json(omq, random_mn, sk, exclude):
...
def test_batch_bt(omq, random_mn, sk, exclude):
    swarm = ss.get_swarm(omq, random_mn, sk, 3)
...
def test_sequence(omq, random_mn, sk, exclude):
    swarm = ss.get_swarm(omq, random_mn, sk, 3)
...
def test_failing_sequence(omq, random_mn, sk, exclude):
    swarm = ss.get_swarm(omq, random_mn, sk, 3)
